...
print(f'Sorted: {data}')  # Финишный список
  ...
  # В данном коде приведен пример пузырьковой сортировки в обе стороны, что сокращает время сортировки более чем вдвое, за счет сокращенного количества итераций.
